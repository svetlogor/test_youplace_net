# 1 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c"
...
# 1 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c" 2
...
# 2 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c" 2
...
# 3 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c" 2
...
# 4 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c" 2
...
typedef struct { char *a[100]; } t_lr_varargs;
t_lr_varargs f_args;
int f_i=0;



char *f_args_param_list[100];
...
Action()
{
	...
	web_link("Start test",
		"Text=Start test", 
		"LAST");
	lr_end_transaction("Start Button", 2);

	}
	
	f_args.a[f_i++] = "ITEMDATA";
	...
	lr_end_transaction("Search Radio", 2);
	...
	lr_end_transaction("Search Select", 2);
	...
	for(i=1; i<=CDs3_count; i++)
	{
            ...
            f_args.a[f_i++] = "Value=test";
            f_args.a[f_i++] = "ENDITEM";


	}
	lr_end_transaction("Search Text", 2);
...
# 5 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c" 2
...
# 6 "c:\\users\\user\\desktop\\test_youplace_net\\\\combined_test_youplace_net.c" 2
